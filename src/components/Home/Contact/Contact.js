    ...
    return (
       ...
       <Grid sx={{p: 5}} container spacing={2}>
                    ...
                    <h2 style={{color: "#E020F3"}}>Contact Info</h2>
                       ...
                       <p style={{ color: 'black'}}> <i style={{color: "blue", fontSize: "25px"}} className=" far fa-envelope"></i> yeasalehofficial2002@gmail.com </p>
                       <p style={{ color: 'black'}}> <i style={{color: "red", fontSize: "25px"}} className=" fas fa-map-marked-alt"></i> 7720, Pangsha , Rajbari, Dhaka</p>
                       <p>  
